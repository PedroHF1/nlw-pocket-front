export function InOrbitIcon() {
  return (
    <svg width={24} height={25} viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      />
      <path d="M6.064 20.948a2.511 2.511 0 100-5.023 2.511 2.511 0 000 5.023z" fill="url(#paint3_linear_84_262)" />
      <path d="M17.958 9.054a2.511 2.511 0 100-5.023 2.511 2.511 0 000 5.023z" fill="url(#paint4_linear_84_262)" />
      <defs>
        <linearGradient
